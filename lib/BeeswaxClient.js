...
var entities = {
    ...
    creativeLineItems: {
        endpoint: '/rest/creative_line_item',
        idField: 'cli_id'
    },
    targetingTemplates: {
...
function BeeswaxClient(opts) {
    ...
    self.useStrict = opts.useStrict === undefined ? true : opts.useStrict;
...
BeeswaxClient.prototype._create = function(endpoint, idField, body) {
    ...
    var baseUrl = urlUtils.resolve(self.apiRoot, endpoint);
    var opts = {
        url: self.useStrict ? baseUrl + '/strict' : baseUrl,
        body: body
    };
